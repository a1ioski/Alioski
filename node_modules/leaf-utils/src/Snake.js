...
module.exports = class SnakeGame {
    constructor(options = {}) {
        ...
        if (typeof options.emojis.board !== "string")
            throw new TypeError("INVALID_EMOJI: Board Emoji must be a string.");
        if (!options.emojis.food) options.emojis.food = "🍎";
        if (typeof options.emojis.food !== "string")
            throw new TypeError("INVALID_EMOJI: Food Emoji must be a string.");

        if (!options.emojis.up) options.emojis.up = "⬆️";
        if (typeof options.emojis.up !== "string")
            throw new TypeError("INVALID_EMOJI: Up Emoji must be a string.");
        ...
        if (typeof options.foods !== "object")
            throw new TypeError("INVALID_FOODS: Foods Emojis must be a array.");
        ...
        if (typeof options.authorOnly !== "string")
            throw new TypeError(
                "INVALID_OTHERS_MESSAGE: Others Message must be a string."
            );

        if (!options.stopButton) options.emojis = {};
        if (!options.stopButton.stopLabel)
            options.stopButton.stopLabel = "Stop";
        if (typeof options.stopButton.stopLabel !== "string")
            throw new TypeError(
                "INVALID_STOP_BUTTON: Stop Label must be a string."
            );
        if (!options.stopButton.stopStyle)
            options.stopButton.stopStyle = "DANGER";
    ...
    newFoodLoc() {
        ...
        if (this.options.foods.length) {
            this.options.emojis.food =
                this.options.foods[
                    Math.floor(Math.random() * this.options.foods.length)
                ];
        }
    ...
    async startGame() {
        ...
        const embed = new MessageEmbed()
            ...
            .setFooter({
                text: this.message.author.tag + " | Score: " + this.score,
        ...
        const stop = new MessageButton()
            .setLabel(this.options.stopButton.stopLabel)
            .setStyle(this.options.stopButton.stopStyle)
            .setCustomId("snake_stop");

        const dis1 = new MessageButton()
            .setLabel("\u200b")
            .setStyle("SECONDARY")
            .setCustomId("dis1")
            .setDisabled(true);
        const dis2 = new MessageButton()
            .setLabel("\u200b")
            .setStyle("SECONDARY")
            .setCustomId("dis2")
            .setDisabled(true);
        const dis3 = new MessageButton()
            .setLabel("\u200b")
            .setStyle("SECONDARY")
            .setCustomId("dis3")
            .setDisabled(true);
        const dis4 = new MessageButton()
            .setLabel("\u200b")
            .setStyle("SECONDARY")
            .setCustomId("dis4")
            .setDisabled(true);
        const dis5 = new MessageButton()
            .setLabel("\u200b")
            .setStyle("SECONDARY")
            .setCustomId("dis5")
            .setDisabled(true);
        const dis6 = new MessageButton()
            .setLabel("\u200b")
            .setStyle("SECONDARY")
            .setCustomId("dis6")
            .setDisabled(true);
        const dis7 = new MessageButton()
            .setLabel("\u200b")
            .setStyle("SECONDARY")
            .setCustomId("dis7")
            .setDisabled(true);
    ...
    ButtonInteraction(msg) {
        ...
        collector.on("collect", async (btn) => {
            if (btn.user.id !== this.message.author.id)
                return btn.reply({
                    content: this.options.authorOnly.replace(
                        "{{author}}",
