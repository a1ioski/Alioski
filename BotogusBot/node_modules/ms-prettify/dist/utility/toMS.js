...
const justANumber_1 = __importDefault(require("./justANumber"));
function default_1(string) {
    ...
    strings.forEach((v, i) => {
        ...
        if ((0, justANumber_1.default)(v)) {
            ...
            let no = parseFloat(v), str = (_d = (_c = v.substring((_b = no.toString()) === null || _b === void 0 ? void 0 : _b.length)) === null || _c === void 0 ? void 0 : _c.trim()) === null || _d === void 0 ? void 0 : _d.toLowerCase();
